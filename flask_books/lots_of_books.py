...
user1 = User(id=1, first_name="Omar", last_name="Albeik", email="omaralbeik@gmail.com")
user2 = User(id=2, first_name="Jane", last_name="Doe", email="jane.doe@gmail.com")
user3 = User(id=3, first_name="John", last_name="Applesead", email="john.applesead@apple.com")
...
genre2 = Genre(id=2, name="Fiction", user_id=1)
genre3 = Genre(id=3, name="Mystery", user_id=1)
genre4 = Genre(id=4, name="Horror", user_id=1)
genre5 = Genre(id=5, name="Poetry", user_id=2)
genre6 = Genre(id=6, name="Diaries", user_id=2)
genre7 = Genre(id=7, name="Series", user_id=3)
genre8 = Genre(id=8, name="Biographies", user_id=3)
